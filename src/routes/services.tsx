        ...
        <div className="shell flex flex-col items-center text-center">
          <Reveal className="flex flex-col items-center w-full">
            ...
            <p className="text-[#5D5A55] text-[16px] md:text-[18px] font-normal tracking-[0.2px] max-w-2xl mx-auto mb-10 md:mb-14">
              A visual journal of raw emotions and untold stories. Every image is a testament to the
              beautiful, unscripted moments that make you who you are.
            </p>
          </Reveal>
        </div>
                ...
                <div key={idx} className="w-full flex flex-col group">
                  ...
                  <div className="mt-[20px] text-center w-full flex flex-col justify-start flex-grow">
                    ...
                    <div className="mt-[8px]">
                      ...
                      >
                        <span className="border-b border-transparent hover:border-[#2d2c2a] pb-[1px] transition-all">
                          view more
                        </span>
                      </Link>
                    </div>
