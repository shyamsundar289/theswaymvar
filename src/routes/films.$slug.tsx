...
export const Route = createFileRoute("/films/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "description", content: loaderData.film.description || "A wedding film by theswaymvar." },
    ],
  }),
  ...
  return (
    <div className="bg-background pt-[var(--header-height)] min-h-[calc(100svh-var(--header-height))]">
      <div className="shell py-8 md:py-12">
        <Reveal>
          ...
          <div className="mt-12 md:mt-16">
            ...
            <h1 className="font-display mt-4 text-4xl md:text-7xl">
              {film.title}
            </h1>
            {film.description && (
      ...
      {film.chapters && film.chapters.length > 0 && (
        <FilmStories chapters={film.chapters} />
      )}
    </div>
  );
}
