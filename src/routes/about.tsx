  ...
  return (
    <div className="bg-[#FAF8F4] text-foreground min-h-[100svh] selection:bg-[#d1cbbd]/30 overflow-x-hidden">
      ...
      {/* ══════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════ */}
      <section className="relative w-full pt-[clamp(5rem,10vw,8rem)] pb-[clamp(1rem,2vw,2rem)] px-[5vw]">
          ...
          <Reveal delay={0.15}>
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1px_1fr] gap-[clamp(2.5rem,4vw,2.5rem)] items-start">
              ...
              <div className="flex flex-col items-center text-center">
                <svg width="80" height="56" viewBox="0 0 100 70" fill="none" className="mb-4 text-[#2d2c2a] md:w-[100px] md:h-[70px]">
              ...
              {/* Wedding Photography */}
              <div className="flex flex-col items-center text-center">
                <svg width="72" height="56" viewBox="0 0 90 70" fill="none" className="mb-4 text-[#2d2c2a] md:w-[90px] md:h-[70px]">
          ...
          <Reveal delay={0.15}>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 border border-[#d1cbbd] lg:border-none rounded-lg lg:rounded-none overflow-hidden">
              ...
              <div className="flex flex-col items-center text-center py-[clamp(1.5rem,5vw,2rem)] px-[clamp(1rem,3vw,1.5rem)] border-b lg:border-b-0 lg:border-r border-[#d1cbbd]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2d2c2a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mb-[clamp(0.5rem,2vw,1rem)]">
                ...
                <a href="https://www.instagram.com/theswaymvar" target="_blank" rel="noopener" className="font-sans text-[clamp(0.75rem,3.5vw,0.75rem)] text-[#5D5A55] hover:text-[#c4a97d] transition-colors">
                  @theswaymvar
                </a>
              </div>
              ...
              <div className="flex flex-col items-center text-center py-[clamp(1.5rem,5vw,2rem)] px-[clamp(1rem,3vw,1.5rem)] border-b lg:border-b-0 lg:border-r border-[#d1cbbd]">
                ...
                <a href="mailto:hello@theswayamvar.com" className="font-sans text-[clamp(0.75rem,3.5vw,0.75rem)] text-[#5D5A55] hover:text-[#c4a97d] transition-colors">
              ...
              <div className="flex flex-col items-center text-center py-[clamp(1.5rem,5vw,2rem)] px-[clamp(1rem,3vw,1.5rem)] border-b lg:border-b-0 lg:border-r border-[#d1cbbd]">
                ...
                <a href="tel:+918949422388" className="font-sans text-[clamp(0.75rem,3.5vw,0.75rem)] text-[#5D5A55] hover:text-[#c4a97d] transition-colors">
                  +91 89494 22388
                </a>
              </div>
              ...
              <div className="flex flex-col items-center text-center py-[clamp(1.5rem,5vw,2rem)] px-[clamp(1rem,3vw,1.5rem)] border-b lg:border-b-0 lg:border-r border-[#d1cbbd]">
                ...
                <a href="https://wa.me/918949422388" target="_blank" rel="noopener" className="font-sans text-[clamp(0.75rem,3.5vw,0.75rem)] text-[#5D5A55] hover:text-[#c4a97d] transition-colors">
                  +91 89494 22388
                </a>
              </div>
