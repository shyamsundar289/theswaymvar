...
export function CinematicFilmSection() {
  ...
  const desktopPath =
    "M 350 -100 L 350 50 Q 350 150 450 150 L 850 150 A 150 150 0 0 1 850 450 L 350 450 A 150 150 0 0 0 350 750 L 550 750 Q 650 750 650 850 L 650 1000";

  const mobilePath =
    "M 200 -100 L 200 80 Q 200 180 300 180 L 400 180 A 120 120 0 0 1 400 420 Q 300 420 300 520 L 300 580 Q 300 680 200 680 A 120 120 0 0 0 200 920 L 300 920 Q 400 920 400 1020 L 400 1300";

  return (
    <section
      ref={containerRef}
      className="relative w-full bg-[#F3EFE6] overflow-hidden py-24 md:py-32 border-y border-[#15130F]/10"
    >
      {/* DESKTOP SVG */}
...
function FilmReel({ cx, cy, r, scale, opacity, direction, scrollProgress }: FilmReelProps) {
  ...
  return (
    <motion.g style={{ x: cx, y: cy, scale, opacity }} className="transition-none">
      <motion.g
        style={{ rotate: rotation, originX: "0px", originY: "0px" }}
        className="transition-none"
      >
