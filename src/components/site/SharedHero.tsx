    ...
    <section className="w-full bg-background pt-[55px] md:pt-[70px] pb-[50px] md:pb-[65px] shell">
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 md:px-12 h-full w-full -translate-y-2 md:-translate-y-4">
          <div className={`${mutedCol} opacity-80`}>
            {icon}
          </div>
          
          <p className={`font-sans text-[11px] tracking-[0.25em] uppercase ${mutedCol} mt-4 opacity-90`}>
            {eyebrow}
          </p>
          ...
          <div className={`font-sans text-[13px] md:text-[15px] ${mutedCol} max-w-md mx-auto leading-[1.6] opacity-90`}>
            {description}
          </div>
          ...
          {ctaText && ctaLink && (
            ...
            >
              {ctaText}
              <div className={`w-5 h-5 rounded-full border ${borderCol} flex items-center justify-center`}>
