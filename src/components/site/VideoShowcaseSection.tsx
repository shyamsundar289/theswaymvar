  ...
  return (
    <section className="shell py-16 md:py-24">
      ...
      <Reveal className="flex flex-col items-center mt-16 md:mt-24 text-center pb-8">
        <svg width="100" height="100" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-sm mb-2">
          <defs>
            <mask id="camera-cutouts">
              ...
              <g className="animate-spin" style={{ transformOrigin: "40px 40px", animationDuration: "6s", animationTimingFunction: "linear" }}>
              ...
              <g className="animate-spin" style={{ transformOrigin: "80px 40px", animationDuration: "6s", animationTimingFunction: "linear" }}>
              ...
              <rect x="36" y="66" width="48" height="22" fill="none" stroke="black" strokeWidth="2.5" />
            </mask>
          </defs>
